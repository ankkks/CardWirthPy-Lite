...
19.06.22 WSN4：メニュー・エネミーカードのアニメ速度設定の反映（途中）
19.06.21 宿選択画面で最後に選択した順で宿がソートされるようにした(Reboot4)
               従来型の並びは整列＞名前で行えます。
19.06.20 メッセージ速度1と2が同じ速度で表示される(Reboot4)
