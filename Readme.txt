...
2017/1/4 まで　Wsn.2 KC分岐「手札」を除外(全て/アイテムでの手札検索はOK)して取り込み
...
・Rebootでメニューカード名と効果系カード名のフォントサイズが異なっているのを一致させるようにした(バグ？)
...
・シナリオ選択ダイアログのシナリオインストール(CTRL+I)/新規フォルダ(CTRL+N)機能をショートカット化しボタンは省略、また複数のシナリオドロップは非対応
