...
12/31 まで　Wsn.2 KC分岐「手札」を除外(全て/アイテムでの手札検索はOK)して取り込み
...
[スキンの自動生成ダイアログ]が出た場合はスキンが入っていません。
...
[シナリオ]
Py1.1ベースなのでCW1.20～1.50仕様/WSN1に対応します。NEXTシナリオは貼り紙に表示されません。
...
--------------------------------------------------------------------------
●更新情報
16.12.31 Classicスキンを同梱するようにした 
16.12.29 Rebootに合わせて「＠WSN2」を追加
...
16.12.26 保留していた画像の高解像度規格とシナリオインストールのD&Dに対応(上書き時の削除オプションはなし)
                ※書き換え量がすさまじかったのでRebootで多数エンバグしているしこちらでもしているかもしれません。
                　なんかおかしいなと思ったら教えて下さい。
