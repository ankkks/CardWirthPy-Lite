...
19.03.23 wxイメージのアルファ値を乗算する処理で不正なメモリ領域を読み込んでいる(Reboot3.3)
19.03.23 最大値ボーナスのアイコンの背景カラーも白になっていた(エンバグ)
19.03.23 WSN3：システム称号「＠Wsn.3」の判定が機能していなかった 
19.03.23 11以上の不正値ボーナス・ペナルティの背景カラーを白に変更(CW準拠)
